select top 10
		...
		,dept.ComposeDept as 'WardDepartmentCode' --แก้ไขวันที่ 17/09/2568
		,dbo.sysconname(dept.ComposeDept,10145,2) as 'WardDepartmentNameTH' --แก้ไขวันที่ 17/09/2568
		,dbo.sysconname(dept.ComposeDept,10145,1) as 'WardDepartmentNameEN' --แก้ไขวันที่ 17/09/2568
		...
		,dbo.sysconname(a.FromClinic,42203,1) as 'AdmitLocationNameEN' --เพิ่มวันที่ 27/02/2568
			...
			left join DEVDECRYPT.dbo.PYTS_SETUP_WARD_CODE dept on a.AdmWard = dept.Code