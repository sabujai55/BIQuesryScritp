select	
		...
		, dbo.sysconname(b.TreatmentCode,42075,2) as TreatmentNameTH --modify 2026-03-18
		, dbo.sysconname(b.TreatmentCode,42075,1) as TreatmentNameEN --modify 2026-03-18
...
from	DNSYSCONFIG a
		inner join DEVDECRYPT.dbo.PYTS_SETUP_FACILITYREQ_METHOD_DTL_TREATMENT b on a.Code=b.Code
