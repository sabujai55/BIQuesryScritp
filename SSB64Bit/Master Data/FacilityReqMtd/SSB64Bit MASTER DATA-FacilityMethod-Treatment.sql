...
select	
		...
		, cast(substring(b.com,17,10) as varchar(10)) as TreatmentCode
		, dbo.sysconname(cast(substring(b.com,17,10) as varchar(10)),42075,2) as TreatmentNameTH
		, dbo.sysconname(cast(substring(b.com,17,10) as varchar(10)),42075,1) as TreatmentNameEN

		, cast(substring(b.com,29,5) as varchar(10)) as HNActivityCodeOPD
		, dbo.sysconname(cast(substring(b.com,29,5) as varchar(10)),42093,2) as HNActivityOPDNameTH
		, dbo.sysconname(cast(substring(b.com,29,5) as varchar(10)),42093,1) as HNActivityOPDNameEN

		, cast(substring(b.com,35,5) as varchar(10)) as HNActivityCodeIPD
		, dbo.sysconname(cast(substring(b.com,35,5) as varchar(10)),42093,2) as HNActivityIPDNameTH
		, dbo.sysconname(cast(substring(b.com,35,5) as varchar(10)),42093,1) as HNActivityIPDNameEN

		, cast(substring(b.com,41,5) as varchar(10)) as HNActivityCodeCheckup
		, dbo.sysconname(cast(substring(b.com,41,5) as varchar(10)),42093,2) as HNActivityCheckupNameTH
		, dbo.sysconname(cast(substring(b.com,41,5) as varchar(10)),42093,1) as HNActivityCheckupNameEN
...
from	DNSYSCONFIG a
		join DNSYSCONFIG_DETAIL b on b.MasterCtrlCode = a.CtrlCode and b.Code = a.Code and b.additioncode = 'TREATMENT'
