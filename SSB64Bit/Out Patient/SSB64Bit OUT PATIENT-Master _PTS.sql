...
select 'PT2' as BU
		...
		,cn.ComposeDept as ClinicDepartmentCode --    ¹
		,dbo.sysconname(cn.ComposeDept,10145,2) as ClinicDepartmentNameTH --    ¹
		,dbo.sysconname(cn.ComposeDept,10145,1) as ClinicDepartmentNameEN --    ¹
		...
		,case when vnp.CloseVisitCode in ('003','888','999') then 'InActive' else 'Active' end as [Status] --modify 2026-04-02
...
from	HNOPD_PRESCRIP vnp
		...
		left join DEVDECRYPT.dbo.PYTS_SETUP_CLINIC_CODE cn on vnp.clinic=cn.Code --    
