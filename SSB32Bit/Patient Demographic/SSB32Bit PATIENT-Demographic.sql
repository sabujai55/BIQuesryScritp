...
select TOP 10	
		...
		, (select dbo.cutsortchar(ne.LASTNAME) from PATIENT_NAME ne where ne.HN = a.HN and ne.SUFFIX = 1) as LastNameEN
		, b.BirthDateTime 
		, b.gender as Gender
		...
		, b.Province
		, b.PostalCode
		, (select pa.MOBILEPHONENO from PATIENT_ADDRESS pa where pa.HN = a.HN and pa.SUFFIX = 1) as MobilePhoneNo
		, (select pa.TEL from PATIENT_ADDRESS pa where pa.HN = a.HN and pa.SUFFIX = 1) as Tel2 
		...
		, '' as Tel1 
		, a.MAKEDATETIME as CreatePatientDate 
		, a.LASTVISITDATE as LastUpdateDateTime 
		, a.BIRTHPLACE as BirthPlace 
		, '' as PatientStatusCode
		, '' as PatientStatusNameTH
