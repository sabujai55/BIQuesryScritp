...
select 	bs.site_code as "BU"
		...
		, coalesce(bd2.description_en, ap2."ClinicNameEN", ap3."ClinicNameEN") as "ClinicNameEN"
...
select 	bs.site_code as "BU"
		...
		, coalesce(ap2."ClinicNameEN", bd2.description_en) as "ClinicNameEN"
...
select 	bs.site_code as "BU"
		...
		, coalesce(bd2.description_en, ap2."ClinicNameEN") as "ClinicNameEN"
