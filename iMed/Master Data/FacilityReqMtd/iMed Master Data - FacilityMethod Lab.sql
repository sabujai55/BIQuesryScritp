...
, d.item_code as "LabCode"
, d.common_name as "LabNameTH"
, d.print_name_en as "LabNameEN"
, d.base_specimen_id as "SpecimenCode1"
, bs.description as "SpecimenNameTH1"
, '' as "SpecimenNameEN1"
, '' as "SpecimenCode2"
, '' as "SpecimenNameTH2"
, '' as "SpecimenNameEN2"
...
left join base_specimen bs on bs.base_specimen_id = d.base_specimen_id
join base_order_sub_category bosc on d.base_order_sub_category_id = bosc.base_order_sub_category_id 
LEFT JOIN --OPD
		(
