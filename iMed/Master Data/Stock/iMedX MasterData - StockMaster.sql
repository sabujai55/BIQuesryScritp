select 	'PTW' as BU
		...
		, '' as "GradeNameTH"
		, '' as "GradeNameEN"
		, i.base_item_group_id as "ColourCode"
		, b3.description as "ColourNameTH"
		, b3.description as "ColourNameEN"
		, '' as "Maker"
		, '' as MakerNameTH
		, '' as MakerNameEN
		, '' as "Tariff"
...
from 	item i 
		...
		left join base_item_group b3 on b3.base_item_group_id = i.base_item_group_id
