...
, case when tlnv.fix_lab_normal_value_type_id = '1' then '�����·ء������'
when tlnv.fix_lab_normal_value_type_id = '2' then '��������'
when tlnv.fix_lab_normal_value_type_id = '3' then '�����¼����'
when tlnv.fix_lab_normal_value_type_id = '4' then '�����¼��˭ԧ'
when tlnv.fix_lab_normal_value_type_id = '5' then '�����ª��' else 'None'end as "GenderNameTH"
, '' as "GenderNameEN"
, '' as "NormalName"
, '' as "LowName"
, '' as "HighName"
