...
, i.common_name as "LabNameEN"
, i.base_lab_type_id as "GroupOfLabCode" --แก้ไขวันที่ 4/2/69
, blt.description as "GroupOfLabNameTH" --แก้ไขวันที่ 4/2/69
, '' as "GroupOfLabNameEN"
, '' as "ChartColour"
...
, '' as "SpecimenNameEN"
, bosc.base_order_sub_category_id  as "HNActivityOPD" --แก้ไขวันที่ 4/2/69
, bosc.description  as "HNActivityOPDNameTH" --แก้ไขวันที่ 4/2/69
, '' as "HNActivityOPDNameEN"
, bosc.base_order_sub_category_id as "HNActivityIPD" --แก้ไขวันที่ 4/2/69
, bosc.description as "HNActivityIPDNameTH" --แก้ไขวันที่ 4/2/69
...
, i.base_lab_type_id as "FacilityRMSNo" --แก้ไขวันที่ 4/2/69
, blt.description as "FacilityRMSNoNameTH" --แก้ไขวันที่ 4/2/69
...
, '' as "TypeOfLabCode" --แก้ไขวันที่ 4/2/69
, '' as "TypeOfLabName" --แก้ไขวันที่ 4/2/69
, '' as "LabResultStyle"
...
, 0 as "NeverShowUpOnHelp" --แก้ไขวันที่ 4/2/69
, '' as "CanBeZeroPrice"
, '' as "EntryWantedDate"
...
left join base_order_sub_category bosc on i.base_order_sub_category_id = bosc.base_order_sub_category_id --แก้ไขวันที่ 4/2/69
...
, '' as "ShowHighPriceWarning"
, '0' as "OpenPrice"
, 1 as "NeverShowUpOnHelp" --แก้ไขวันที่ 4/2/69
, '' as "CanBeZeroPrice"
, '' as "EntryWantedDate"
, '0' as "OffCode"
, '' as "InfectionControl"
...
left join fix_lab_normal_value_type flnvt on flnvt.fix_lab_normal_value_type_id = tlnv.template_lab_normal_value_id) t1
--where t1."GroupOfLabCode" != ''